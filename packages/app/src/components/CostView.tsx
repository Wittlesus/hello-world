...
export function CostView() {
  ...
  const remainingColor = remainingPercent > 50 ? 'text-green-400' : remainingPercent > 20 ? 'text-yellow-400' : 'text-red-400';
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-gray-800">
              <th className="text-left py-2 px-3 text-[10px] uppercase tracking-wider text-gray-500 font-semibold">#</th>
              <th className="text-left py-2 px-3 text-[10px] uppercase tracking-wider text-gray-500 font-semibold">Date</th>
              <th className="text-right py-2 px-3 text-[10px] uppercase tracking-wider text-gray-500 font-semibold">Cost</th>
              <th className="text-right py-2 px-3 text-[10px] uppercase tracking-wider text-gray-500 font-semibold">Tokens</th>
              <th className="text-right py-2 px-3 text-[10px] uppercase tracking-wider text-gray-500 font-semibold">Tasks</th>
            </tr>
          </thead>
          <tbody>
