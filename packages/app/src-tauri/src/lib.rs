...
#[tauri::command]
fn get_factory(project_path: &str) -> Result<Value, String> {
    read_json_file(project_path, "factory.json")
}

#[tauri::command]
fn save_factory(project_path: &str, data: Value) -> Result<(), String> {
    write_json_file(project_path, "factory.json", &data)
}
