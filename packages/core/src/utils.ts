...
const WATCHER_ADJECTIVES = [
  'amber', 'brave', 'coral', 'dusty', 'fuzzy',
  'golden', 'jade', 'lunar', 'misty', 'noble',
  'pale', 'quiet', 'rusty', 'silver', 'sleepy',
  'swift', 'tangy', 'velvet', 'windy', 'zesty',
];

const WATCHER_ANIMALS = [
  'badger', 'beaver', 'cobra', 'dingo', 'eagle',
  'ferret', 'gecko', 'heron', 'ibis', 'jackal',
  'kestrel', 'lemur', 'marmot', 'newt', 'otter',
  'panda', 'quail', 'raven', 'stoat', 'thrush',
];
